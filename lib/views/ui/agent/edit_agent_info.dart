...
class _EditAgencyState extends State<EditAgency> {
  TextEditingController company =
      TextEditingController(text: agentInfo!.company);
  TextEditingController hqAddress =
      TextEditingController(text: agentInfo!.hqAddress);
  TextEditingController workingHrs =
      TextEditingController(text: agentInfo!.workingHrs);
